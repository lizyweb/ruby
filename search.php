...
<head>
  ...
  <style>
    ...
    <style>
        .cta {
            background: linear-gradient(to right,rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url("img/back/img-3.jpg") fixed center center;
...
<body style="background-color: rgb(233,233,233);">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            ...
            <li><a href="#">Patient Database</a></li>
            </ol>
        ...
        <div class="container">
            <div class="row d-flex align-items-center justify-content-center">
                <div class="col-md-6 contact wow fadeInUp" data-wow-delay="0.1s">
                    <h3 class="wow fadeInUp mb-3 text-white" data-wow-delay="0.1s">Search Patients</h3>
                    <form action="search_results.php" method="get">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                <label for="userName" class="form-label" style="color: white;">Search by :</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                <label for="userName" class="form-label" style="color: white;">Enter search term : </label>
    ...
    <div class="container-2 mt-3 mb-3">
      <h3 class="d-flex align-items-center justify-content-center mb-3">Patient Databases:</h3>
      <ul class="dashboard-links d-flex align-items-center justify-content-center">
        <li><a href="allrecords.php">View All Patient Details</a></li>
        <li><a href="allrecordscsv.php">Download all Patient details</a></li>
      </ul>
    </div>
