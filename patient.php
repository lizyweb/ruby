...
<head>
  ...
  <style>
    ...
    <style>
        .cta {
            background: linear-gradient(to right,rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url("img/back/img-1.jpg") fixed center center;
        ...
        <div class="container">
            <div class="row d-flex align-items-center justify-content-center">
                <div class="col-md-6 contact wow fadeInUp" data-wow-delay="0.1s">
                    <h3 class="wow fadeInUp mb-3 text-white" data-wow-delay="0.1s">Patient Information Form</h3>
